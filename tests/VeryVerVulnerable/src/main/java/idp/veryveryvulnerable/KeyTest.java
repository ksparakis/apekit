...
/**
 * Created by igorp on 12/6/15.
 */
public class KeyTest {

        public static void main(String[] args) {
            System.out.println("Hello, World");
            String test      = "Not an aws key";
            String test2     = "lalalalaalalalalalalalalaalalala";
            String test3     = "OMG ahahahah OMG ahahaha";
            String test4     = "mom mom mom mom mom";
            String test5     = "when this happens this happens";
            String test6     = "But not really, but yea";
            String test7     = "INPUT FROM SOMEHWERE";
            String test8     = "";

            //Fake AWS keys
            String accesskey = "AKIAAD9046B4XXJXLX6Q";
            String secretkey = "qe9/mgOzc-5uN1oNFfnk++2xcOleLllFGkVj56Nk";
            //Fake Twilio keys
            ...
            String signature   = "ACxwNDtvkO2nsXs2fa4LdAjRq98TA204gsd2ODrvR4mTZY.e.nYU15SH";
